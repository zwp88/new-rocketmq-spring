...
public class ClientProducerApplication implements CommandLineRunner {
    ...
    void testAsyncSendMessage() {
        ...
        log.info("normalSend to topic {} sendReceipt={}", normalTopic, completableFuture0);
        ...
        log.info("fifoSend to topic {} sendReceipt={}", fifoTopic, completableFuture1);
        ...
        log.info("delaySend to topic {} sendReceipt={}", delayTopic, completableFuture2);
    }
    ...
    void testSendDelayMessage() {
        ...
        log.info("delaySend to topic {} sendReceipt={}", delayTopic, sendReceipt);
    ...
    void testSendTransactionMessage() throws ClientException {
        ...
        log.info("transactionSend to topic {} sendReceipt={}", transTopic, sendReceipt);
